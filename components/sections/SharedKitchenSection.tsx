...
/** Identifiant Agenda (section « Intégrer le calendrier »), ex. xxx@group.calendar.google.com */
...
/** Clé API navigateur (pas le project ID) — restreindre par référent HTTP + API Calendar uniquement. */
...
export function SharedKitchenSection({ hideIntro = false }: SharedKitchenSectionProps) {
  ...
  const showCalendar = showApiCalendar || showIframe
  ...
  return (
    <div id="cuisine-partagee" className="scroll-mt-[5.5rem]">
      ...
      {/* CTA — orange institutionnel (charte mosque-gold), comme le don / accueil */}
